...
# Spotify (Converter dem Deb)
apt-key adv --keyserver hkp://keyserver.ubuntu.com:80 --recv-keys 931FF8E79F0876134EDDBDCCA87FF9DF48BF1C90
echo 'deb http://repository.spotify.com stable non-free' | tee /etc/apt/sources.list.d/spotify.list
# FreeOffice (Converter dem Deb)
...
# Compiz Reloaded (Converter dem Deb)
...
# Gestos do touchpad (Converter dem Deb)
...
# Tecla Super para abrir o Whisker (Converter dem Deb)
echo '[Desktop Entry]
Exec=xcape -e "Super_L=Control_L|Escape"
Name=Xcape
Type=Application
OnlyShowIn=XFCE;' | tee /etc/xdg/autostart/xcape.desktop
# Bash-It/Undistract-Me (Converter dem Deb)
echo "[Desktop Entry]
Type=Application
Name=Bash It
Exec=bash /opt/radix-desktop/bash_it.sh
Icon=xterm
StartupNotify=true" | tee /etc/xdg/autostart/bash_it.desktop
echo "#!/bin/bash
